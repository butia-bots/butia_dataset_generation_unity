...
namespace UnityEngine.Perception.Randomization.Scenarios
{
    ...
    /// </summary>
    [AddComponentMenu("Perception/Scenarios/Physics Fixed Length Scenario")]
    public class PhysicsFixedLengthScenario: PerceptionScenario<PhysicsFixedLengthScenario.Constants>
    {
        /// <summary>
        ...
        protected override void OnUpdate()
        {
            ...
            else
            {
                ...
                if (currentIterationFrame == constants.framesPerIteration - 5) {
